...
class Line {
    ...
    public boolean isIntersection(Line ano) {
        int res1 = Ccw.getCcw(this.a, this.b, ano.a);
        int res2 = Ccw.getCcw(this.a, this.b, ano.b);
        int res3 = Ccw.getCcw(ano.a, ano.b, this.a);
        int res4 = Ccw.getCcw(ano.a, ano.b, this.b);
